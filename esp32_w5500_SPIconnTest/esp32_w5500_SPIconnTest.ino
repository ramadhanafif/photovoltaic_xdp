/**
   @file esp32_w5500_SPIconnTest.ino
   @author Muhammad Afif Ramadhan
   @brief Simple program to check SPI communication with W5500 ethernet module
   Board: ESP32
   In depth SPI for ESP32 example: https://github.com/espressif/arduino-esp32/blob/master/libraries/SPI/examples/SPI_Multiple_Buses/SPI_Multiple_Buses.ino
   @version 1
   @date 2022-06-30
